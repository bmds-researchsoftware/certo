...
-- :name seed-insert-val-usertypes
-- :command :execute
-- :result :raw
...
-- :name seed-insert-sys-fields-sys-fields
-- :command :execute
-- :result :raw
...
-- :name seed-insert-sys-fields-val-controls
-- :command :execute
-- :result :raw
...
-- :name seed-insert-sys-fields-val-types
-- :command :execute
-- :result :raw
...
-- :name seed-insert-sys-fields-sys-users
-- :command :execute
-- :result :raw
...
-- :name seed-insert-sys-event-classes
-- :command :execute
-- :result :raw
...
-- :name seed-insert-sys-event-classes-fields
-- :command :execute
-- :result :raw
...
-- :name seed-insert-sys-select-options 
-- :command :execute
-- :result :raw
